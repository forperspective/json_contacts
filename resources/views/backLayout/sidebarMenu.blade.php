...
<div class="left_col scroll-view">
  <div class="navbar nav_title" style="border: 0;">
    <a href="{{url('dashboard')}}" class="site_title"><i class="fa fa-user"></i> <span>Laravel</span></a>
  </div>
  ...
  <div class="profile">
    <div class="profile_pic">
      ...
      <img src="https://cdn4.iconfinder.com/data/icons/mayssam/512/user-512.png" alt="..." class="img-circle profile_img">
    </div>
  ...
  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
      ...
      @if (Sentinel::getUser()->hasAnyAccess(['contact*']))
        <li><a><i class="fa fa-cog"></i> Contacts <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="{{route('contact.index')}}">All Contacts</a></li>
            <li><a href="{{route('contact.create')}}">New Contacts</a></li>
          </ul>
        </li>
      @endif
